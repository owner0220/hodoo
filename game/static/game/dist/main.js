...
, function(e, t, i) {
    ...
    t.getSwingBlockVelocity = function(e, t) {
        var i, a = e.getVariable(n.successCount), r = e.getVariable(n.gameScore), o = e.getVariable(n.gameUserOption).hookSpeed;
        if (o)
            return o(a, r);
        switch (!0) {
        case a < 1:
        ...
        return e.getVariable(n.hardMode) && (i = 1.1),
        Math.sin(t / (200 / i))
    }
    ;
    ...
    t.touchEventHandler = function(e) {
        if (e.getVariable(n.gameStartNow) && !(e.debug && e.paused || a(e) !== n.hookNormal)) {
            e.removeInstance("tutorial"),
            e.removeInstance("tutorial-arrow");
            var t = e.getInstance("block_".concat(e.getVariable(n.blockCount)));
            t && t.status === n.swing && (e.setTimeMovement(n.hookUpMovement, 500),
            t.status = n.beforeDrop)
        }
    }
    ;
    t.addSuccessCount = function(e) {
        ...
        e.getVariable(n.hardMode) && e.setVariable(n.ropeHeight, e.height * e.utils.random(.35, .55)),
        t && t(i)
    }
    ;
...
, function(e, t, i) {
    ...
    var r = function(e, t) {
        ...
        if (i) {
            ...
            e.x += e.vx,
            e.y += e.vy,
            (e.y + o < 0 || e.y > t.height || e.x + o < 0 || e.x > t.width) && (e.visible = !1)
        }
    };
    t.flightAction = r;
    var o = function(e, t) {
...
, function(e, t, i) {
    ...
    var r = function(e, t) {
        e.status === a.rotateLeft ? e.y - e.width >= t.height && (e.visible = !1,
        e.status = a.out,
        (0,
        n.addFailedCount)(t)) : e.y >= t.height && (e.visible = !1,
        e.status = a.out,
        (0,
        n.addFailedCount)(t))
    };
    t.blockAction = function(e, t, i) {
        ...
        if (o.visible) {
            ...
            case a.drop:
                ...
                o.startDropTime = i,
                o.vy += o.ay * u,
                o.y += o.vy * u + .5 * o.ay * Math.pow(u, 2);
                var l = function(e, t) {
                  ...
                  , h = function(e) {
                    ...
                    e.originHypotenuse = Math.sqrt(Math.pow(e.height, 2) + Math.pow(e.outwardOffset, 2)),
                    t.playAudio("rotate")
                };
                switch (l) {
                case 1:
                ...
                case 5:
                    ...
                    10 !== g && 15 !== g || t.setTimeMovement(a.lightningMovement, 150),
                    e.y = d,
                    c.y = d,
                    c.x = o.x - o.calWidth,
                    c.collisionX = c.x + o.width;
                    var f = .3 * o.width;
                    (o.x > t.width - 2 * f || o.x < -f) && t.setVariable(a.hardMode, !0),
                    5 === l ? (e.perfect = !0,
                    (0,
                    n.addScore)(t, !0),
                    t.playAudio("drop-perfect")) : ((0,
                    n.addScore)(t),
                    t.playAudio("drop"))
                }
                break;
            case a.land:
                t.getTimeMovement(a.moveDownMovement, [[e.y, e.y + (0,
                n.getMoveDownValue)(t, {
                    pixelsPerFrame: function(e) {
                        return e / 2
                    }
                })]], function(i) {
                    e.visible && (e.y = i,
                    e.y > t.height && (e.visible = !1))
                }, {
                    name: e.name
                }),
                e.x += (0,
                n.getLandBlockVelocity)(t, i);
                break;
            case a.rotateLeft:
            case a.rotateRight:
                ...
                if (p)
                    e.rotate += m / 8 * y,
                    e.y += t.pixelsPerFrame(.7 * t.height),
                    e.x += t.pixelsPerFrame(.3 * t.width) * y;
                else {
    ...
    t.endAnimate = function(e) {
        if (e.getVariable(s.gameStartNow)) {
            ...
            var o = e.getImg("score")
              ...
              , l = .35 * e.width
              , d = u * l / c;
            e.ctx.drawImage(o, .61 * e.width, .038 * e.width, l, d),
            (0,
            r.drawYellowString)(e, {
                string: n,
                size: .06 * e.width,
            ...
            for (var h = e.ctx, g = e.getImg("heart"), f = g.width, v = g.height, m = .08 * e.width, p = v * m / f, y = 1; y <= 3; y += 1)
                h.save(),
                y <= i && (h.globalAlpha = .2),
                h.drawImage(g, .66 * e.width + (y - 1) * m, .16 * e.width, m, p),
                h.restore()
        }
    }
    ;
    t.startAnimate = function(e) {
        if (e.getVariable(s.gameStartNow)) {
            ...
            if (!t || [s.land, s.out].indexOf(t.status) > -1) {
                if ((0,
                r.checkMoveDown)(e) && (0,
                r.getMoveDownValue)(e))
                    return;
                if (e.checkTimeMovement(s.hookUpMovement))
                    return;
                var i = (0,
                r.getAngleBase)(e)
            ...
            case 2:
                (0,
                o.addFlight)(e, 1, "leftToRight");
                break;
            case 6:
                (0,
                o.addFlight)(e, 2, "rightToLeft");
                break;
            case 8:
                (0,
                o.addFlight)(e, 3, "leftToRight");
                break;
            case 14:
                (0,
                o.addFlight)(e, 4, "bottomToTop");
                break;
            case 18:
                (0,
                o.addFlight)(e, 5, "bottomToTop");
                break;
            case 22:
                (0,
                o.addFlight)(e, 6, "bottomToTop");
                break;
            case 25:
                (0,
                o.addFlight)(e, 7, "rightTopToLeft")
            }
        }
    }
}
, function(e, t, i) {
    ...
    t.tutorialPainter = function(e, t) {
        if (!t.checkTimeMovement(a.tutorialMovement) && (0,
        n.getHookStatus)(t) === a.hookNormal) {
            var i = t.ctx
              , r = e.name
              , o = t.getImg(r);
...
, function(e, t, i) {
    ...
    t.hookAction = function(e, t, i) {
        var r = t.getVariable(a.ropeHeight);
        e.ready || (e.x = t.width / 2,
        e.y = -1.5 * r,
        e.ready = !0),
        t.getTimeMovement(a.hookUpMovement, [[e.y, e.y - r]], function(t) {
            e.y = t
        }, {
            after: function() {
                e.y = -1.5 * r
...
, function(e, t, i) {
    ...
    t.cloudAction = function(e, t) {
        if (!e.ready) {
            ...
            e.originX = e.x,
            e.ax = t.pixelsPerFrame(e.width * t.utils.random(.05, .08) * t.utils.randomPositiveNegative()),
            e.y = t.utils.random(s.y, 1.2 * s.y)
        }
        e.x += e.ax,
        (e.x >= e.originX + e.width || e.x <= e.originX - e.width) && (e.ax *= -1),
        (0,
        n.checkMoveDown)(t) && (e.y += 1.2 * (0,
        n.getMoveDownValue)(t)),
        e.y >= t.height && (e.y = .66 * -t.height,
        e.count += 4,
        r(e))
    }
    ;
...
, function(e, t, i) {
    ...
    t.lineAction = function(e, t, i) {
        var r = e;
        r.ready || (r.y = t.getVariable(a.lineInitialOffset),
        r.ready = !0,
...
, function(e, t, i) {
    ...
    var r = function(e) {
        ...
        o > e.height || (e.getTimeMovement(a.moveDownMovement, [[o, o + (0,
        n.getMoveDownValue)(e, {
            pixelsPerFrame: function(e) {
                return e / 2
            }
        })]], function(e) {
        ...
        e.setVariable(a.lineInitialOffset, e.height - .394 * r),
    ...
    var o = function(e, t, i) {
      ...
      , s = function(e) {
        ...
        (0,
        n.checkMoveDown)(e) && e.setVariable(a.bgLinearGradientOffset, r + 1.5 * (0,
        n.getMoveDownValue)(e));
      ...
      , d = function() {
        function e() {
            ...
            document.createElement("canvas").getContext) {
                ...
                s && (this.canvas.style.width = "".concat(d, "px"),
                ...
                this.isTouchDevice ? (document.addEventListener("touchstart", function(e) {
                ...
                window.alert("HTML5 Canvas is not supported in your browser.")
        }
        var t, i, n;
        return t = e,
        (i = [{
            ...
            value: function(e) {
                ...
                return i || (null !== t ? (this.setVariable(e, t),
                t) : null)
            }
        }, {
            key: "addImg",
            ...
            value: function(e, t, i) {
                ...
                if (l) {
                    l.processing || ("hook" === a.name && console.log(t),
                    ...
                    this.checkTimeMovement(e) ? d() : (this.timeMovementFinishArr.push(e),
                    d(!0),
                    s && s())
                }
            }
            ...
            value: function() {
                ...
                this.paused ? this.lastPausedAt = e : this.pausedTime += e - this.lastPausedAt
            }
        }, {
...
, function(e, t, i) {
    ...
    window.TowerGame = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
          ...
          , v = function(e) {
            return "/static/game/assets/".concat(e)
        };
        ...
        f.setVariable(l.ropeHeight, .4 * f.height),
